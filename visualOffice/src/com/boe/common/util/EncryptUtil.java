...
public class EncryptUtil {
	private static String DEFAULT_KEY = "boecim";
	...
	public String encryptStr(String strIn) throws Exception {
	...
	public String decryptStr(String strIn) throws Exception {
