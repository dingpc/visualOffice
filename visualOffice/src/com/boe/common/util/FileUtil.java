...
public class FileUtil {
	...
	private static final String UPLOADDIR = "file/upload/";
	private static final String DOWNLOADDIR = "file/download/";
	...
	public static List<Map<String, Object>> upload(HttpServletRequest request,
		...
		int i = 0;
		for (Iterator<Map.Entry<String, MultipartFile>> it = fileMap.entrySet().iterator(); 
				it.hasNext(); i++) {
	...
	public static void download(HttpServletRequest request,
		...
		String ctxPath = request.getSession().getServletContext() .getRealPath("/") + FileUtil.DOWNLOADDIR;
